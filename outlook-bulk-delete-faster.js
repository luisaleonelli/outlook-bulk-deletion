  ...
  const deleteEvent = async (eventElement, eventIndex, totalFound) => {
    try {
      ...
      try {
        ...
        menuDeleteButton = await waitForButtonByText(SELECTORS.deleteEventButtonText, 2000);
      ...
      const confirmDeleteButton = await waitForButtonByText(SELECTORS.deleteEventButtonText, 2000);
